...
#SBATCH --job-name=lbh-easy-qmix        # Job name (to track progress)
...
srun python src/main.py --config=qmix --env-config=gymma with env_args.time_limit=100 env_args.key="Hacking-2p-Easy-v0" common_reward=True save_model=True save_model_interval=500000
