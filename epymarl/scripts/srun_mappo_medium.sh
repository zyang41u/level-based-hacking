...
#SBATCH --job-name=lbh-medium-mappo        # Job name (to track progress)
...
srun python src/main.py --config=mappo --env-config=gymma with env_args.time_limit=100 env_args.key="Hacking-3p-Medium-v0" common_reward=False save_model=True save_model_interval=500000
