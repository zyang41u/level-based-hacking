...
#SBATCH --job-name=lbh-medium-qmix        # Job name (to track progress)
...
srun python src/main.py --config=qmix --env-config=gymma with env_args.time_limit=100 env_args.key="Hacking-3p-Medium-v0" common_reward=True save_model=True save_model_interval=500000
